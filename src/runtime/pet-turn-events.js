...
const TYPES = new Set(['turn_started', 'thinking', 'visual_selected', 'visual_image', 'visual_observation', 'visual_compare', 'visual_recall', 'memory_recall', 'assistant_message', 'turn_completed', 'turn_failed'])
