...
## Visual Canonical Dedup Production Migration

The approved Visual Canonical Dedup implementation was applied to the current
production lineage after a pre-migration backup. The production runtime was
fast-forwarded from `819fb2ce33013c86ae2ccfb56bdad2dfa8d6e60a` to the approved
source commit. Only the primary DSH Web Host was stopped and restarted. The
secondary Host, Local Brain, Android, LAN/Tailscale endpoint configuration,
Conversation Store raw archive, PetMemory, and Dream runtime were not changed.

```text
FINAL_STATUS=VISUAL_CANONICAL_DEDUP_PRODUCTION_ACCEPTED
APPROVED_SOURCE_COMMIT=3847c1d4adc044490996f0b8485617a0d9c356cd
PRODUCTION_COMMIT=3847c1d4adc044490996f0b8485617a0d9c356cd
PRODUCTION_BRANCH=fix/android-tailscale-endpoint
PRODUCTION_ROOT=/home/vitamin_c/.local/share/vc-ai-pet/sandbox
OLD_PRODUCTION_COMMIT=819fb2ce33013c86ae2ccfb56bdad2dfa8d6e60a
PRIMARY_OLD_PID=4049942
PRIMARY_NEW_PID=743502
PRIMARY_RESTARTED=YES
SECONDARY_RESTARTED=NO
LOCAL_BRAIN_RESTARTED=NO
SECONDARY_PET_BUNDLE_ENABLED=NO

BACKUP_DIR=/home/vitamin_c/.local/share/vc-ai-pet/backups/visual-dedup-pre-migration-20260909-111741
BACKUP_VISUAL_DB_SHA256=95a29f3b4d950e3f7de70f1c62a3d0ea352155b1071569675933befeab74cda3

MIGRATION_APPLY_1=PASS
MIGRATION_APPLY_2=PASS
SECOND_APPLY_ALIASES_CREATED=0
SECOND_APPLY_OCCURRENCES_CREATED=0
SECOND_APPLY_NEW_ROOT=0
MODEL_CALLS=0
PET_MEMORY_WRITES_DURING_MIGRATION=0
DREAM_RUNS=0

VISUAL_PHYSICAL_ROOTS_BEFORE=41
VISUAL_CANONICAL_ROOTS_BEFORE=41
VISUAL_EVENTS_BEFORE_APPLY=26
VISUAL_TERMS_BEFORE_APPLY=2594
VISUAL_OCCURRENCES_BEFORE_APPLY=0
VISUAL_ALIASES_BEFORE_APPLY=0
VISUAL_PHYSICAL_ROOTS_AFTER=41
VISUAL_CANONICAL_ROOTS_AFTER=26
VISUAL_EVENTS_AFTER_APPLY=26
VISUAL_TERMS_AFTER_APPLY=2962
VISUAL_OCCURRENCES_AFTER=41
VISUAL_ALIASES_AFTER=15
VISUAL_EVENTS_AFTER_PRIMARY_BOOT=33
VISUAL_TERMS_AFTER_PRIMARY_BOOT=3741
BACKFILL_CURSOR_AFTER_PRIMARY_BOOT=3243
LEGACY_OBSERVATION_CURSOR_AFTER_PRIMARY_BOOT=3243
VISUAL_EVENTS_LOST=NO
VISUAL_TERMS_LOST=NO

ARCHIVE_ROWS_BEFORE=359
ARCHIVE_ROWS_AFTER=359
ARCHIVE_MAX_SEQUENCE_BEFORE=3243
ARCHIVE_MAX_SEQUENCE_AFTER=3243
CONVERSATION_STORE_RAW_CHANGED=NO
PET_FACT_BEFORE=189
PET_FACT_AFTER=189
PET_MEMORY_PROVENANCE_BEFORE=110
PET_MEMORY_PROVENANCE_AFTER=110
DREAM_LOG_BEFORE=12
DREAM_LOG_AFTER=12
PET_MEMORY_CHANGED=NO
DREAM_LOG_CHANGED=NO

PET_HOST_STATE_HTTP=200
LAN_UI_PORT=17870
GALLERY_COUNT=26
GALLERY_DUPLICATES_COLLAPSED=YES
G05_DISTINCT_FRAME_PRESERVED=YES
G05_OCCURRENCE_COUNT=3
G07_CANONICALIZED=YES
G07_OCCURRENCE_COUNT=3
OCCURRENCE_HISTORY_VISIBLE=YES
DIFFERENT_OWNER_TEXTS_PRESENT=YES
ORIGINAL_IMAGE_REOPEN=YES
LOCAL_BRAIN_HTTP=200
PRIMARY_DSH_ROOT_HTTP=200

ANDROID_MODIFIED=NO
ANDROID_NATIVE_CHANGED=NO
Tailscale_CHANGED=NO
LAN_ENDPOINT_BEHAVIOR_CHANGED=NO
PRODUCTION_DB_MODIFIED=YES
PRODUCTION_DEPLOYED=YES
NO_CHAT_OR_IMAGE_ACCEPTANCE_TRAFFIC=YES
```

The primary runtime initialization advanced the existing legacy observation
cursor from `2884` to the archive maximum `3243`, adding indexed visual events
and terms from already persisted raw messages. The raw archive row count and
maximum sequence stayed unchanged, and the visual counters remained stable in
the subsequent read-only check; this was not a new chat or image submission.
