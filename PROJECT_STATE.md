...
本次只扩展现有 VC-AI-PET LAN ingress self-heal 和 Android Companion 连接层。
不修改 Pet runtime、Visual Memory、PetMemory、Dream、Reflection、Local Brain
或生产数据库。

WINDOWS_WIFI_INTERFACE=WLAN
LAN_PORT=17870
LAN_PORTPROXY_LISTEN_ADDRESS=CURRENT_WINDOWS_WIFI_IPV4
LAN_PORTPROXY_CONNECT_ADDRESS=CURRENT_WSL_IPV4
LAN_FIREWALL_RULE=VC-AI-PET LAN Companion 17870
LAN_FIREWALL_SCOPE=PRIVATE/WLAN/TCP_17870/LOCALSUBNET
SELF_HEAL_TASK=\VC-AI-PET\LAN Forwarding Self-Heal
SELF_HEAL_SCRIPT=scripts/windows/vc-ai-pet-lan-forwarding-self-heal.ps1
LIVE_WINDOWS_WIFI_IPV4=192.168.1.199
LIVE_CURRENT_WSL_IPV4=172.25.248.161
LIVE_LAN_PORTPROXY=192.168.1.199:17870->172.25.248.161:17870
LIVE_WINDOWS_CURRENT_LAN_HTTP=200
LIVE_SELF_HEAL_CURRENT_RUN=NOOP
LIVE_TASK_LAST_RESULT=0
TAILSCALE_PORTPROXY_PRESERVED=YES
