...
const messages=buildPetMessages({identity:LI_HUAHUA_IDENTITY,state:{mood:.8,energy:.4,boredom:.2,sleepiness:.6,attachment:.7},memories:[{level:'fact',content:'今天主人摸了我一次。'}],userText:'花花你困不困？'})
