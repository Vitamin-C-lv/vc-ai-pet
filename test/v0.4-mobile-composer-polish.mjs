...
const hiddenSendRule = redesignCss.match(/\.composer-action-button\[hidden\]\s*\{([\s\S]*?)\n\}/u)?.[1] ?? ''
...
console.log('EMPTY_SEND_DISPLAY=none')
console.log('EMPTY_SEND_LAYOUT_WIDTH=0')
console.log('EMPTY_TEXTAREA_EXPANDS=YES')
console.log('TEXT_SEND_VISIBLE=YES')
console.log('IMAGE_SEND_VISIBLE=YES')
console.log('TEXT_IMAGE_SEND_VISIBLE=YES')
console.log('PLUS_ALWAYS_VISIBLE=YES')
console.log('COMPOSER_SINGLE_ROW=YES')
